...
<img src="{{ site.baseurl }}/assets/images/inventorying_specimen pro app.png" alt="" width="450"/>{: .align-center}

   3 | In the top right hand corner of the app, click the plus symbol. 
   
<img src="{{ site.baseurl }}/assets/images/inventorying_creating a collection.png" alt="" width="500"/>{: .align-center}

   4 | Make sure the window pop-up has the Museum/Lab Collection banner highlighted and fill in the collection details including, name of the collection, date, and the name of the collector. 
 ...
 *Step* | Under *Basic Information...*
 --- | ---
   6 | The object number is generated by the app. To add the Specimen ID, locate the number assigned to the specimen, typically written directly on it—for example, a series like "1 of 5/2/09".
   7 | Record the cabinet and drawer numbers where the specimen is physically stored.
