...
1. Click on the lookup list icon next to *NearestPlace* to see if the feature you need already exists. If it does, select it. If it doesn't, go ahead and enter it yourself.
...
FYI when used in *NearestPlace*, "area" generally denotes that the locality is within the USGS quad map of the same name, e.g. "Sunland area".
{: .notice--warning}
