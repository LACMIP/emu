...
Alternate Loc ID
: A table of paired values: *Institution Code* and *Institution Number*. This is common for specimens transferred to LACMIP from other institutions, and is also where you can find field numbers assigned by collectors. Ex: *Institution Code* = "CIT" and *Institution Number* = "5046", or *Institution Code* = "field number" and *Institution Number* = "AH180817." Typically, these numbers are recorded on round colored labels (green = UCLA; gold = CIT; red = CSUN or another instituion).
