...
Determination By
: Equivalent to [dwc:georeferencedBy](https://dwc.tdwg.org/terms/#dwc:georeferencedBy): "A list (concatenated and separated) of names of people, groups, or organizations who determined the georeference (spatial representation) for the Location." You will need to attach a [Parties]({{ site.baseurl }}/documentation/parties/) record to this field.
