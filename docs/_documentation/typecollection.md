...
*Step* | *Type Numbering Workflow*
   --- | ---
    ...
    6. Trim | <img src="{{ site.baseurl }}/assets/images/imls_numbering2.jpg" alt="" width="500"/>{: .align-center}
