...
*Step* | *In the Catalogue and Taxonomy Module...*
   --- | ---
    ...
    6  | Mark the new taxonomic entry as "Unknown" under "Currently Accepted" and leave the "Currently Accepted Name" field blank [(Example.)]({{ site.baseurl }}/assets/images/Taxonomy_Invertebrates tab_Currently Accepted Name.png)
