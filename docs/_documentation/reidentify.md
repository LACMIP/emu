...
{% include figure image_path="/assets/images/reidentify_types.jpg" alt="re-identification tool" caption="Screenshot of the EMu Catalogue module illustrating how to reidentify type specimens *Tools > Re-identify*. " %}
